...
{
    public class LivelihoodDashboardPageModel : PageModel
    {
        public IWebHostEnvironment _iweb;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly USAID_ICANContext _context;

        public LivelihoodDashboardPageModel(USAID_ICANContext contex, IWebHostEnvironment hostenvironment, IHttpContextAccessor httpContextAccessor)
        {
            _context = contex;
        ...
        public void OnGet()
        {
            ...
            path = Path.Combine(webRootPath, "LivelihoodDashboard.sydx");
            name = GetRoleName();
            regid = GetRegionId();
            ...
            ViewData["LivelihoodDashboard"] = path;
