...
{
    public class CrossCuttingDashboardPageModel : PageModel
    {
        public IWebHostEnvironment _iweb;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly USAID_ICANContext _context;

        public CrossCuttingDashboardPageModel(USAID_ICANContext contex, IWebHostEnvironment hostenvironment, IHttpContextAccessor httpContextAccessor)
        {
            _context = contex;
        ...
        public void OnGet()
        {
            ...
            path = Path.Combine(webRootPath, "CrossCuttingDashboard.sydx");
            //path = Path.Combine(webRootPath, "CrossCut.sydx");
            name = GetRoleName();
            regid = GetRegionId();
            ...
            ViewData["CrossCuttingDashboard"] = path;
