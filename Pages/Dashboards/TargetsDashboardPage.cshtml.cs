...
{
    public class TargetsDashboardPageModel : PageModel
    {
        public IWebHostEnvironment _iweb;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly USAID_ICANContext _context;

        public TargetsDashboardPageModel(USAID_ICANContext contex, IWebHostEnvironment hostenvironment, IHttpContextAccessor httpContextAccessor)
        {
            _context = contex;
        ...
        public void OnGet()
        {
            ...
            path = Path.Combine(webRootPath, "PerformanceIndicators.sydx");
            name = GetRoleName();
            regid = GetRegionId();
            ...
            ViewData["PerformanceIndicators"] = path;
