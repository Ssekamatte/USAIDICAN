...
{
    public class NutritionandHealthPageModel : PageModel
    {
        public IWebHostEnvironment _iweb;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly USAID_ICANContext _context;

        public NutritionandHealthPageModel(USAID_ICANContext contex, IWebHostEnvironment hostenvironment, IHttpContextAccessor httpContextAccessor)
        {
            _context = contex;
        ...
        public void OnGet()
        {
            ...
            path = Path.Combine(webRootPath, "NutritionandHealthDashboard.sydx");
            name = GetRoleName();
            regid = GetRegionId();
            ...
            ViewData["NutritionandHealthDashboard"] = path;
