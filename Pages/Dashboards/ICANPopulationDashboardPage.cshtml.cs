...
{
    public class ICANPopulationDashboardPageModel : PageModel
    {
        public IWebHostEnvironment _iweb;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly USAID_ICANContext _context;

        public ICANPopulationDashboardPageModel(USAID_ICANContext contex, IWebHostEnvironment hostenvironment, IHttpContextAccessor httpContextAccessor)
        {
            _context = contex;
        ...
        public void OnGet()
        {
            ...
            path = Path.Combine(webRootPath, "ICANPopulation.sydx");
            name = GetRoleName();
            regid = GetRegionId();
