...
{
    public class GatewayDashboardPageModel : PageModel
    {
        public IWebHostEnvironment _iweb;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly USAID_ICANContext _context;

        public GatewayDashboardPageModel(USAID_ICANContext contex, IWebHostEnvironment hostenvironment, IHttpContextAccessor httpContextAccessor)
        {
            _context = contex;
        ...
        public void OnGet()
        {
            ...
            path = Path.Combine(webRootPath, "GatewayDashboard.sydx");
            name = GetRoleName();
            regid = GetRegionId();
            ...
            ViewData["GatewayDashboard"] = path;
